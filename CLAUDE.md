...
release notes are generated from the commits — when a commit changes something a user would notice, add a `Release-Note:` trailer written in their language, not the commit subject's. see docs/RELEASING.md
