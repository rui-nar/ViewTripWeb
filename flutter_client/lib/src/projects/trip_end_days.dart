...
class TripEndOrphans {
  ...
  /// activity dates and memory dates (see [ProjectNotifier.orderedDayKeys]),
  /// so these stay visible whatever day-meta says. Their day-meta is
  /// deliberately left alone: silently wiping the notes of a day the user can
  /// still see would be worse than leaving them.
  ///
